...
from tennis_autodistillation.utils.drawing import draw_minimap
from tennis_autodistillation.utils.transformations import transform_point
from tennis_autodistillation.utils.coords_court_map import COORDS_COURT_MAP
from tennis_autodistillation.utils.drawing import draw_keypoints
...
if __name__ == "__main__":
    ...
    main(
        input_video="/home/rafael_shotquality_com/code/tennis-autodistill/short_rally.mp4",
        path_classification_model="/home/rafael_shotquality_com/code/tennis-autodistill/runs/classify/train/weights/best.pt",
        path_player_detector="/home/rafael_shotquality_com/code/tennis-autodistill/runs/detect/train3/weights/best.pt",
        path_keypoints_detector="/home/rafael_shotquality_com/code/tennis-autodistill/runs/pose/train5/weights/best.pt",
